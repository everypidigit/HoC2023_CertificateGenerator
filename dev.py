...
def send_email(subject, body, to_email, cert_path, vouch_path, address, student_name):
    ...
    try:
        ...
        if "502" in e:
            ...
            sys.exit("THE PROGRAM EXECUTION WAS CUT SHORT BECAUSE THE EMAIL HAS NOT BEEN SENT")
...
if __name__ == "__main__":
    ...
    # user = "everypidigit@gmail.com"
    # password = "yziz tldl uxot ahwj"
