...
if __name__ == "__main__":
    ...
    smtp_hoc = "mail.hourofcode.kz"
    user = "hoc2023certificates1@hourofcode.kz"
    password = "Rapture9949!"
    
    emails = {"hoc2023certificates1@hourofcode.kz": "Rapture9949!",
              "daniyar@ustemrobotics.kz" : "afos vsor ermk crua", 
              "astana.code@gmail.com" : "w1z3e6iXLWz2", 
              }
...
Пиши в директ нашей официальной страницы в Instagram - @hourofcode.kz
    ...
    for key, value in emails.items():
        with smtplib.SMTP_SSL(smtp_hoc, 465) as server:
                server.login(key, value)
                ...
                for i in range(0,500):
                    ...
                    if role == "teacher" or role == "volunteer":
                        pass
